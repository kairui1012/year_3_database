...
INSERT INTO BookingPassenger
    (BookingID, BookingCabinID, PassengerID, AgeCategoryID, FareRuleID,
     InfantBedOption, IsChaperonedYouth, DailySupervisionFee, FinalFare)
VALUES
(3, 3, 7,  1, NULL,'SharedBed',    0,  0.00,  420.00); -- BPID=7   Emma       Infant SharedBed (15%×2800)
...
INSERT INTO BookingPassenger
    (BookingID, BookingCabinID, PassengerID, AgeCategoryID, FareRuleID,
     InfantBedOption, IsChaperonedYouth, DailySupervisionFee, FinalFare)
VALUES
(4, 5, 9,  3,  6, 'NotApplicable', 0,  0.00, 1000.00); -- BPID=9   Kevin      Teen   (O-802, adjacent guardian OK)
...
INSERT INTO BookingPassenger
    (BookingID, BookingCabinID, PassengerID, AgeCategoryID, FareRuleID,
     InfantBedOption, IsChaperonedYouth, DailySupervisionFee, FinalFare)
VALUES
(5, 6, 16, 1, NULL,'Cot',          0,  0.00,  600.00); -- BPID=13  Sophie     Infant Cot (50%×1200)
...
VALUES
(1,  22.00, 0, 0); -- Ahmad:      22.0 kg  ✓ within limit
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(2,  27.50, 1,  0); -- Nurul Hana: 27.5 kg  ✗ over 25 kg limit

-- Booking 2 passengers — Voyage 1 (25 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(3,  18.00, 0, 0); -- James:      18.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(4,  20.00, 0, 0); -- Margaret:   20.0 kg  ✓

-- Booking 3 passengers — Voyage 1 (25 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(5,  24.00, 0, 0); -- Rajesh:     24.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(6,  19.50, 0, 0); -- Priya:      19.5 kg  ✓

-- Booking 4 passengers — Voyage 1 (25 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(8,  26.00, 1,  0); -- Sarah:      26.0 kg  ✗ over 25 kg limit
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(9,  12.00, 0, 0); -- Kevin:      12.0 kg  ✓

-- Booking 5 passengers — Voyage 2 (30 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(10, 28.00, 0, 0); -- Hafiz:      28.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(11, 33.50, 1,  0); -- Christine:  33.5 kg  ✗ over 30 kg limit
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(12,  8.50, 0, 0); -- Lucas:       8.5 kg  ✓

-- Booking 6 passengers — Voyage 2 (30 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(14, 22.00, 0, 0); -- Elena:      22.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(15, 25.00, 0, 0); -- Roberto:    25.0 kg  ✓

-- Booking 7 passengers — Voyage 2 (30 kg limit)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(16, 25.00, 0, 0); -- Daniel:     25.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(17, 15.00, 0, 0); -- Zara:       15.0 kg  ✓

-- Booking 8 passengers — Voyage 2 (30 kg limit, booking will be cancelled)
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(18, 29.00, 0, 0); -- Lim Wei Jian: 29.0 kg  ✓
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(19, 31.00, 1,  0); -- Siti Aishah:  31.0 kg  ✗ over 30 kg limit
INSERT INTO BookingBaggage
    (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(20, 10.00, 0, 0); -- Ryan Lim:     10.0 kg  ✓
...
VALUES
(21, 20.00, 0, 0); -- Marco:    20.0 kg ✓
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(22, 18.50, 0, 0); -- Giulia:   18.5 kg ✓
-- Booking 10 (V3, 23 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(23, 22.50, 0, 0); -- Thomas:   22.5 kg ✓
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(24, 19.00, 0, 0); -- Elizabeth:19.0 kg ✓
-- Booking 11 (V3, 23 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(25, 24.50, 1,  0); -- Chen Wei: 24.5 kg ✗ over 23 kg limit
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(26, 17.00, 0, 0); -- Li Mei:   17.0 kg ✓
-- Booking 12 (V4, 25 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(27, 23.00, 0, 0); -- Jack:     23.0 kg ✓
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(28, 21.50, 0, 0); -- Emily:    21.5 kg ✓
-- Booking 13 (V4, 25 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(29, 27.00, 1,  0); -- Robert:   27.0 kg ✗ over 25 kg limit
-- Booking 14 (V5, 28 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(30, 26.00, 0, 0); -- Amir:     26.0 kg ✓
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(31, 22.00, 0, 0); -- Priya:    22.0 kg ✓
-- Booking 15 (V5, 28 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(32, 30.00, 1,  0); -- Tan:      30.0 kg ✗ over 28 kg limit
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(33,  8.00, 0, 0); -- Mei Xin:   8.0 kg ✓
-- Booking 16 (V5, 28 kg limit)
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(34, 25.00, 0, 0); -- David:    25.0 kg ✓
INSERT INTO BookingBaggage (BookingPassengerID, WeightKG, IsOverLimit, ExcessFee)
VALUES
(35, 23.50, 0, 0); -- Grace:    23.5 kg ✓
