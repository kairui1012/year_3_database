 ...
 *   RoutePortID 8  = Langkawi stop  (Route 3, StopSequence 2)
 *   RoutePortID 9  = Phuket stop    (Route 3, StopSequence 3)
 *   RoutePortID 10 = Krabi stop     (Route 3, StopSequence 4)
...
VALUES
(2, 8,  3, 30),   -- Langkawi: Mangrove Kayak
(2, 8,  4, 40),   -- Langkawi: Eagle Square
(2, 9,  5, 25),   -- Phuket:   Phi Phi Snorkel
(2, 9,  6, 50),   -- Phuket:   Old Town Walk
(2, 10, 7, 35),   -- Krabi:    Railay Beach
(2, 10, 8, 45);   -- Krabi:    Tiger Cave Hike
